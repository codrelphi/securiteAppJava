...
public class ProduitServiceServiceLocator extends org.apache.axis.client.Service implements fr.service.ProduitServiceService {
    ...
    private java.lang.String ProduitWSPort_address = "http://localhost:8484/";
    ...
    public fr.service.ProduitWS getProduitWSPort() throws javax.xml.rpc.ServiceException {
    ...
    public fr.service.ProduitWS getProduitWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fr.service.ProduitWSPortBindingStub _stub = new fr.service.ProduitWSPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fr.service.ProduitWS.class.isAssignableFrom(serviceEndpointInterface)) {
                fr.service.ProduitWSPortBindingStub _stub = new fr.service.ProduitWSPortBindingStub(new java.net.URL(ProduitWSPort_address), this);
                _stub.setPortName(getProduitWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.fr/", "ProduitServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.fr/", "ProduitWSPort"));
        }
